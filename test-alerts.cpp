...
{
  REQUIRE(hiActiveCoolingUpperLimit(PASSIVE_COOLING, 12) == 35);
  REQUIRE(hiActiveCoolingUpperLimit(HI_ACTIVE_COOLING, 12) == 12);
...
{
  REQUIRE(hiActiveCoolingLowerLimit(PASSIVE_COOLING, 12) == 0);
  REQUIRE(hiActiveCoolingLowerLimit(HI_ACTIVE_COOLING, 12) == 12);
  REQUIRE(hiActiveCoolingLowerLimit(MED_ACTIVE_COOLING, 14) == 14);
...
{
  REQUIRE(checkLowerLimit(10, 35) == NORMAL);
